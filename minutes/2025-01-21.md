...
- **Key Points:**  
  - **Definition of Active Nodes:** Proposed to be based on creating “judges” in the Hashgraph algorithm (i.e., successfully generating events in the majority of rounds).  
